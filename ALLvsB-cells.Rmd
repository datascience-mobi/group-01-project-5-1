...
t_test <- c(1:709) # Erstellung Vektor fÃ¼r p-values
```
...
t_test20 <- p_correction_order[c(1:20)] # Erste 20 Werte behalten
...
threshold <- sum(p_correction_sort <= 0.05) # Threshold auf p = 0.05 gesetzt de korrigierten p-values
...
Unfortunately our model was not very accurate in predicting the health status of the patients.
