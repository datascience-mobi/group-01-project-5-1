...
for (i in 1:nrow(ALLMvalueRemain_threshold)) {
     glm12 <- glm(Tumor ~ Lg_Mvalues[,i], family = "binomial", data = Lg_Mvalues)
     pred <- as.matrix(predict(glm12, type = "response"))
